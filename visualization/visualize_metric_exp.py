...
file_name = "all_seeds_0_0123_DirectionOnly_velocityCtrl0.05_env300_10Trials_CoT"
...
all_exp_data = np.load(
    "/home/nitro/clusteruni/masterarbeit/hddrl/visualization/"+file_name+".npy", allow_pickle=True, encoding="latin1")
...
for metric_ind, metric in enumerate(column_toKeep):
    ...
    ax_arch = fig.add_subplot(2, 3, metric_ind+1)
...
plt.savefig("Results/fig/"+file_name+".png")
plt.show()
