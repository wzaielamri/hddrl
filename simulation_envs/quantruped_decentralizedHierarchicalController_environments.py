...
class QuantrupedFullyDecentralizedHierarchicalEnv(QuantrupedHierarchicalControllerSuperEnv):
    ...
    def __init__(self, config):
        ...
        self.obs_indices["high_level"] = [45, ]
    ...
    def reset(self):
        ...
        obs = {}
        # obs_hlc
        obs["high_level_FL_policy"] = self.cur_obs[self.obs_indices["high_level"]]
        # obs_hlc
        obs["high_level_HL_policy"] = self.cur_obs[self.obs_indices["high_level"]]
        # obs_hlc
        obs["high_level_HR_policy"] = self.cur_obs[self.obs_indices["high_level"]]
        # obs_hlc
        obs["high_level_FR_policy"] = self.cur_obs[self.obs_indices["high_level"]]
        return obs
    ...
    def _low_level_step(self, action):
        ...
        if done_w:
            ...
            rew["high_level_FL_policy"] = (
                old_distance_rob_target - dist_to_go)/4
            rew["high_level_HL_policy"] = (
                old_distance_rob_target - dist_to_go)/4
            rew["high_level_HR_policy"] = (
                old_distance_rob_target - dist_to_go)/4
            rew["high_level_FR_policy"] = (
                old_distance_rob_target - dist_to_go)/4
            # obs_hlc
            # obs_hlc
            obs["high_level_FL_policy"] = self.cur_obs[self.obs_indices["high_level"]]
        ...
        if (distance_rob_target < 0.25):
            ...
            reward_hlc = old_distance_rob_target - dist_to_go
            reward_hlc += self.target_weight * \
...
class QuantrupedFullyDecentralizedHierarchicalFullyDecentralizedEnv(QuantrupedHierarchicalControllerSuperEnv):
    ...
    def _low_level_step(self, action_dict):
        ...
        obs["low_level_FR_policy"] = [
            self.cur_obs[self.obs_indices["low_level_FR_policy"]], self.latentSpace[6:8]]
        rew = {"low_level_FL_policy": rew_val[self.policy_names[4]], "low_level_HL_policy": rew_val[self.policy_names[5]],
               "low_level_HR_policy": rew_val[self.policy_names[6]], "low_level_FR_policy": rew_val[self.policy_names[7]]}
