...
class QuantrupedFullyDecentralizedEnv(QuantrupedFourControllerSuperEnv):
    ...
    def __init__(self, config):
        ...
        self.obs_indices["policy_FL"] = [ 45,
                                         7, 8, 21, 22, 29, 30, 39, 40]
        self.obs_indices["policy_HL"] = [ 45,
                                         9, 10, 23, 24, 31, 32, 41, 42]
        self.obs_indices["policy_HR"] = [ 45,
                                         11, 12, 25, 26, 33, 34, 43, 44]
        self.obs_indices["policy_FR"] = [ 45,
    ...
    def return_policies():
        ...
        obs_space = spaces.Box(-np.inf, np.inf, (9,), np.float64)
        policies = {
