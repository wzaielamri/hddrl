...
class QuantrupedFullyDecentralizedEnv(QuantrupedFourControllerSuperEnv):
    ...
    def __init__(self, config):
        ...
        self.obs_indices["policy_FL"] = [0, 1, 2, 3, 4, 5, 6, 15, 16, 17, 18, 19, 20, 45,
                                         7, 8, 21, 22, 29, 30, 39, 40]
        self.obs_indices["policy_HL"] = [0, 1, 2, 3, 4, 5, 6, 15, 16, 17, 18, 19, 20, 45,
                                         9, 10, 23, 24, 31, 32, 41, 42]
        self.obs_indices["policy_HR"] = [0, 1, 2, 3, 4, 5, 6, 15, 16, 17, 18, 19, 20, 45,
                                         11, 12, 25, 26, 33, 34, 43, 44]
        self.obs_indices["policy_FR"] = [0, 1, 2, 3, 4, 5, 6, 15, 16, 17, 18, 19, 20, 45,
