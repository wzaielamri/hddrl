...
class QuantrupedHierarchicalEnv(QuantrupedHierarchicalControllerSuperEnv):
    ...
    def __init__(self, config):
        ...
        self.obs_indices["high_level"] = [0, 1, 2, 3, 4, 5,6, 15, 16, 17, 18, 19, 20, 45, ]  # range(46)
    ...
    def return_policies():
        ...
        obs_space = spaces.Box(-np.inf, np.inf, (14,), np.float64)  # 15
    ...
    def _low_level_step(self, action):
        ...
        if (distance_rob_target < 0.25):
            ...
            rew["high_level_policy"] = (
                1-(self.env_step_counter/self.target_reward))
            obs["high_level_policy"] = self.cur_obs[self.obs_indices["high_level"]]
...
class QuantrupedHierarchicalFullyDecentralizedEnv(QuantrupedHierarchicalControllerSuperEnv):
    ...
    def __init__(self, config):
        ...
        self.obs_indices["high_level"] = [0, 1, 2, 3, 4, 5,6, 15, 16, 17, 18, 19, 20, 45, ]  # range(47)
